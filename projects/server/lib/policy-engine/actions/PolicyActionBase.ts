...
export abstract class PolicyActionBase extends PolicyElementBase {
    ...
    abstract applyAction(message: JsonRpcMessageWrapper, conditionFindings: ConditionFindings[], config: any, action: PolicyAction): Promise<ActionEventWithConditionId[]>;
}